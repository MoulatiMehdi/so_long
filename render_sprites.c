...
/*   Updated: 2025/03/12 09:04:26 by mmoulati         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void ft_render_sprites_player(t_render *render)
{
    ...
    mlx     = render->mlx;
    sprites[SPRITE_LINK_HURT] =
        ft_sprite_new(mlx, SPRITE_SRC "link.hurt.xpm", 1, 4);
    sprites[SPRITE_LINK_IDLE] =
        ft_sprite_new(mlx, SPRITE_SRC "link.idle.xpm", 1, 4);
    sprites[SPRITE_LINK_DYING] =
        ft_sprite_new(mlx, SPRITE_SRC "link.dying.xpm", 10, 1);
    sprites[SPRITE_LINK_SPIN] =
        ft_sprite_new(mlx, SPRITE_SRC "link.spinning.xpm", 22, 4);
    sprites[SPRITE_LINK_WALKING] =
        ft_sprite_new(mlx, SPRITE_SRC "link.walking.xpm", 8, 4);
    sprites[SPRITE_LINK_LOADING] =
        ft_sprite_new(mlx, SPRITE_SRC "link.loading.xpm", 6, 4);
    sprites[SPRITE_LINK_VICTORY] =
        ft_sprite_new(mlx, SPRITE_SRC "link.victory.xpm", 18, 1);
    sprites[SPRITE_LINK_ATTACKING] =
        ft_sprite_new(mlx, SPRITE_SRC "link.attack.xpm", 12, 4);
}
...
static void ft_render_sprites_tiles(t_render *render)
{
    ...
    sprites[SPRITE_OBSTACLE] =
        ft_sprite_new(mlx, SPRITE_SRC "obstacle.xpm", 5, 1);
    sprites[SPRITE_RUPEE] = ft_sprite_new(mlx, SPRITE_SRC "rupee.xpm", 10, 3);
    sprites[SPRITE_SOLDIER] =
        ft_sprite_new(mlx, SPRITE_SRC "soldier.xpm", 6, 4);
...
static void ft_render_sprites_objects(t_render *render)
{
    ...
    sprites[SPRITE_GAMEOVER] =
        ft_sprite_new(mlx, SPRITE_SRC "gameover.xpm", 1, 1);
    sprites[SPRITE_SWORD_SPIN] =
        ft_sprite_new(mlx, SPRITE_SRC "sword.spin.xpm", 22, 4);
    sprites[SPRITE_SWORD_ATTACK] =
        ft_sprite_new(mlx, SPRITE_SRC "sword.attack.xpm", 12, 4);
    sprites[SPRITE_SWORD_LOADING] =
        ft_sprite_new(mlx, SPRITE_SRC "sword.loading.xpm", 6, 4);
    sprites[SPRITE_SWORD_VICTORY] =
        ft_sprite_new(mlx, SPRITE_SRC "sword_red_victory.xpm", 9, 2);
    sprites[SPRITE_STAR_LOADING_H] =
        ft_sprite_new(mlx, SPRITE_SRC "stars.loading.horizontal.xpm", 28, 4);
    sprites[SPRITE_STAR_LOADING_V] =
        ft_sprite_new(mlx, SPRITE_SRC "starts.loading.vertical.xpm", 19, 6);
}
...
static void ft_render_sprites_loop(t_render *render)
{
    ...
    sprites[SPRITE_LINK_LOADING]->loop   = 3;
    sprites[SPRITE_LINK_ATTACKING]->loop = 1;
    sprites[SPRITE_LINK_DYING]->loop     = 4;
    sprites[SPRITE_LINK_VICTORY]->loop   = 6;
    sprites[SPRITE_LINK_WALKING]->loop   = 4;
    sprites[SPRITE_LINK_HURT]->loop      = 4;
    sprites[SPRITE_RUPEE]->loop          = 8;
    sprites[SPRITE_EXIT]->loop           = 8;
    sprites[SPRITE_SOLDIER]->loop        = 8;
